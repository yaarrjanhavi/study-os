      ...
      >
        ...
        <div className="flex flex-col items-center gap-3 text-center mb-8">
          ...
          <p className="font-mono text-xs text-viridian/60">
            Log in to your focused study desk.
          </p>
        </div>
          ...
          <div className="flex flex-col gap-1.5">
            <div className="flex justify-between items-center">
              ...
              <Link 
                ...
                className="font-mono text-[10px] text-viridian/60 hover:text-viridian"
              >
                Forgot?
              </Link>
            </div>
        ...
        <div className="mt-8 pt-6 border-t border-stone/50 text-center">
          <p className="font-mono text-xs text-viridian/60">
            ...
            <Link href="/signup" className="text-viridian font-bold hover:underline">
              Create one
            </Link>
          </p>
        </div>
